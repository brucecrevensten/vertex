...
var UserLoginView = Backbone.View.extend({
    ...
    render: function() {
        ...
        )).bind('dialogclose', jQuery.proxy(function() {
            this.model.trigger('authFieldsRefresh');
            }, this
        )
        ); //refresh every time it closes
...
var UserLoginFields = Backbone.View.extend( {
    initialize: function() {
        ...
        this.model.bind('authError', jQuery.proxy(function(){
            $(this.el).html( _.template(
        ...
        this.model.bind('authFieldsRefresh', jQuery.proxy(function(){
            $(this.el).html( _.template(
