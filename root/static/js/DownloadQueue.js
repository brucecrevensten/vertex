...
var DownloadQueueView = Backbone.View.extend({
  ...
  convert_cookie_to_queue: function() {
    ...
    render: function() {
      ...
      $(this.el).find('#get_bulk_download').button({
        icons: {
      ...
      $(this.el).find("#download_type_metalink").button({
        icons: { primary: "ui-icon-circle-arrow-s" },
        label:'Bulk Download (.metalink)'
      }).click( function() {
      ...
      $(this.el).find("#download_type_csv").button({
        icons: { primary: "ui-icon-circle-arrow-s" },
      ...
      $(this.el).find("#download_type_kml").button({
        icons: { primary: "ui-icon-circle-arrow-s" },
