...
class spec_3_1(unittest.TestCase):
    ...
    def test_spec_3_1(self):
        ...
        try: self.assertEqual("Granule", sel.get_text("//html/body/div[2]/div/div[4]/div[5]/div/div[2]/div/div/table/thead/tr/th/div"))
        ...
        try: self.assertEqual("Beam mode: ALOS PALSAR sensor: High Resolution Observation Mode (single polarization)", sel.get_text("css=#hanger > ul > li:nth(1)"))
        except AssertionError, e: self.verificationErrors.append(str(e))
